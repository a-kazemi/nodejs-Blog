(function() {
  ...
  ************************************/
    ...
    (function() {
      ...
      while (ordinalizeTokens.length) {
        ...
        formatTokenFunctions['j' + i + 'o'] = ordinalizeToken(
          formatTokenFunctions['j' + i],
          i
        );
      }
      while (paddedTokens.length) {
        i = paddedTokens.pop();
        formatTokenFunctions['j' + i + i] = padToken(
          formatTokenFunctions['j' + i],
          2
        );
      }
      ...
      jMonthsParse: function(monthName) {
        ...
        for (i = 0; i < 12; i += 1) {
          ...
          if (!this._jMonthsParse[i]) {
            ...
            regex =
              '^' + this.jMonths(mom, '') + '|^' + this.jMonthsShort(mom, '');
  ...
  ************************************/
    ...
    jMoment.fn.jDayOfYear = function(input) {
      var dayOfYear =
        Math.round(
          (jMoment(this).startOf('day') - jMoment(this).startOf('jYear')) /
            864e5
        ) + 1;
  ...
  ************************************/
    ...
    jMoment.loadPersian = function(args) {
      var usePersianDigits =
        args !== undefined && args.hasOwnProperty('usePersianDigits')
          ? args.usePersianDigits
          : false;
      var dialect =
        args !== undefined && args.hasOwnProperty('dialect')
          ? args.dialect
          : 'persian';
      moment.locale('fa');
